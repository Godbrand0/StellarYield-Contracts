...
fn test_full_vault_lifecycle_end_to_end() {
    ...
    assert_eq!(user_a_balance_after - user_a_balance_before, expected_yield_a_epoch1);
    ...
    assert_eq!(user_a_balance_after_claim - user_a_balance_before_claim, claimed_remaining);
    ...
    assert_eq!(user_a_balance_after_redeem - user_a_balance_before_redeem, assets_a);
